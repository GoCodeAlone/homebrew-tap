class Wfctl < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "f2b1ee244a4c8f889d7e6ded7461733f5be1670b88e7b49c8345d02bc4e0cd15"
    end
    on_arm do
      url "https://github.com/GoCodeAlone/workflow/releases/download/v#{version}/wfctl-darwin-arm64"
      sha256 "7fbeb61ddbe4e935f39f1580962b5d7783eee07b13b6f069fea95a72740b24eb"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "057bba000a4638b3d84604fb865abb6ec7e814cd4c55f740e3434cc891fe613d"
    end
    on_arm do
      url "https://github.com/GoCodeAlone/workflow/releases/download/v#{version}/wfctl-linux-arm64"
      sha256 "70727f2accc1f8d2906236027529c18e2439b4a0af4e0cc8b3ac3d472e7837cf"
    end
  end
